...
const functionalities = [
  {
    ...
    fullContent:
      "Live Chat lets you talk to Coco-Chat in real-time, allowing seamless interactions for FAQs, support, and more.",
  ...
  },
  {
    ...
    fullContent:
      "With the embed feature, you can drop Coco-Chat into any web project using just a snippet.",
  ...
  },
  {
    ...
    fullContent:
      "Coco-Chat supports user-trained responses so your assistant can reply exactly how you want.",
  ...
  },
  {
    ...
    fullContent:
      "Enable a sleek dark theme for better visual experience, especially at night.",
    icon: <AiOutlineEye />,
  },
  {
    title: "Analytics",
    ...
    fullContent:
      "Track how users interact with Coco-Chat using built-in analytics tools.",
  ...
  },
  {
    ...
    fullContent:
      "Make Coco-Chat multilingual to reach more users around the world.",
